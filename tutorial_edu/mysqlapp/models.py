...
### 아래 테이블 클래스가 만들어지면 항상 아래 명령을 프롬프트에서 수행해야합니다.
# - 클래스 생성이 아닌경우에는 아래 수행은 하지 않아도 됩니다.
#   (클래스 내부에 컬럼변수 추가 또는 속성 수정인 경우는 안해도되지만,
...
class Cart(models.Model) :
    ### cart테이블에는 PK가 2개있지만, 
    #   - Django 모델에서는 한개만 사용가능하기에 임의로 한개만 지정
